	...
	_status.HDWJ_ChangeLog = [
		...
		},
		{
			...
			data: [
				...
				'wechat_zhaoyun', 'wechat_re_zhaoyun', 'wechat_sb_xiahouyuan', 'wechat_sb_xiaoqiao', 'wechat_shen_caocao', 'wechat_sb_sunquan', 'wechat_zhiyin_zhugeke', 'wechat_re_liubiao', 'wechat_re_weiyan', 'wechat_sb_huaxiong', 'wechat_zhi_yuanshu', 'wechat_zhi_fuhuanghou',
		...
		},
		{
			...
			data: [
				...
				'微信：赵云、界赵云、谋夏侯渊、谋小乔、神曹操、谋孙权、极诸葛恪、界刘表、界魏延、谋华雄、志袁术、志伏皇后',
				'其他：天降奇兵——孙寒华、狂神(重置版)',
				'To be continued...',
			],
		},
