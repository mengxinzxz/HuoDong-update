	...
	_status.HDWJ_ChangeLog = [
		...
		},
		{
			...
			data: [
				...
				'wechat_zhaoyun', 'wechat_re_zhaoyun', 'wechat_sb_xiahouyuan', 'wechat_sb_xiaoqiao', 'wechat_shen_caocao', 'wechat_sb_sunquan', 'wechat_zhiyin_zhugeke', 'wechat_re_liubiao', 'wechat_re_weiyan', 'wechat_sb_huaxiong', 'wechat_zhi_yuanshu', 'wechat_zhi_fuhuanghou', 'wechat_zhi_caojie', 'wechat_zhi_caocao',
				'bilibili_sunhanhua', 'bilibili_kuangshen', 'bilibili_Firewin', 'bilibili_lonelypatients', 'bilibili_ningjingzhiyuan', 'bilibili_suixingsifeng', 'bilibili_thunderlei', 'bilibili_xizhicaikobe', 'bilibili_yanjing', 'bilibili_xiaoyaoruyun',
			],
		},
		{
			type: 'text',
			...
			data: [
				...
				'技能调整',
				'重新分配微信三国杀的武将分包',
				'欢杀：杜夔、喵关银屏、糜芳傅士仁、战典韦、诸葛若雪、星荀彧、神二乔、贾充、吴班、战马超、SP欢杀孙坚、界荀彧、谋程昱',
				'微信：赵云、界赵云、谋夏侯渊、谋小乔、神曹操、谋孙权、极诸葛恪、界刘表、界魏延、谋华雄、志袁术、志伏皇后、志曹节、志曹操',
				'其他：天降奇兵——孙寒华、狂神(重置版)、重置活动群名人堂&肘击群&寝室群部分角色',
				'To be continued...',
			],
		},
	];
