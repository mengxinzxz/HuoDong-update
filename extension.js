...
game.bolShowNewPack = function () {
	...
	var HuoDong_players = [
		...
		'Mbaby_xugong', 'Mbaby_zhupeilan', 'Mbaby_zhaoang', 'Mfight_zhangliao', 'Mbaby_shen_lusu', 'Mbaby_sb_sunquan', 'Mbabysp_xuhuang', 'Mbaby_caoanmin', 'Mbaby_bianyue', 'Mbaby_xianglang', 'Mbaby_xielingyu', 'Mbaby_zhangrang',
	];
	//加载
