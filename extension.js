...
game.bolShowNewPack = function () {
	...
	var HuoDong_update = [
		...
		'小程序：SP甄宓、极郭皇后、极辛宪英、谋曹操、谋孙策、极赵云、极典韦、极荀攸、极孙尚香',
		'欢杀：许贡、朱佩兰、赵昂、战张辽、界吴国太、神鲁肃、谋孙权、SP徐晃、曹安民、卞玥、向朗、谢灵毓、张让、谋郭嘉',
		'To be continued...',
	];
	//更新武将
	var HuoDong_players = [
		'bilibili_xiaoyaoruyun', 'bilibili_shuijiaobuboli', 'bilibili_yanjing', 'bilibili_suixingsifeng',
		'wechat_sp_zhenji', 'wechat_zhiyin_guohuanghou', 'wechat_zhiyin_xinxianying', 'wechat_sb_caocao', 'wechat_sb_sunce', 'wechat_zhiyin_zhaoyun', 'wechat_zhiyin_dianwei', 'wechat_zhiyin_xunyou', 'wechat_zhiyin_sunshangxiang',
		'Mbaby_xugong', 'Mbaby_zhupeilan', 'Mbaby_zhaoang', 'Mfight_zhangliao', 'Mbaby_shen_lusu', 'Mbaby_sb_sunquan', 'Mbabysp_xuhuang', 'Mbaby_caoanmin', 'Mbaby_bianyue', 'Mbaby_xianglang', 'Mbaby_xielingyu', 'Mbaby_zhangrang', 'Mbaby_sb_guojia',
	];
	//加载
