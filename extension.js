...
game.bolShowNewPack = function () {
	...
	var HuoDong_update = [
		...
		'小程序：SP甄宓、极郭皇后、极辛宪英、谋曹操、谋孙策、极赵云、极典韦、极荀攸、极孙尚香、谋张辽、谋黄月英、谋貂蝉、极陆逊',
	...
	var HuoDong_players = [
		...
		'wechat_sp_zhenji', 'wechat_zhiyin_guohuanghou', 'wechat_zhiyin_xinxianying', 'wechat_sb_caocao', 'wechat_sb_sunce', 'wechat_zhiyin_zhaoyun', 'wechat_zhiyin_dianwei', 'wechat_zhiyin_xunyou', 'wechat_zhiyin_sunshangxiang', 'wechat_sb_zhangliao', 'wechat_sb_huangyueying', 'wechat_sb_diaochan', 'wechat_zhiyin_luxun',
