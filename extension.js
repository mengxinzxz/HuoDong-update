	...
	_status.HDWJ_ChangeLog = [
		...
		},
		{
			...
			data: [
				...
				'微信：赵云、界赵云、谋夏侯渊、谋小乔、神曹操、谋孙权、极诸葛恪、界刘表、界魏延、谋华雄、志袁术、志伏皇后、志曹节、志曹操、志张角；重新分配微信三国杀的武将分包',
				'其他：天降奇兵——孙寒华、狂神(重置版)、吾猪万睡、沐如风晨、点点(带16张皮肤，可在本体换肤界面中切换)、重置活动群名人堂&肘击群&寝室群部分角色',
				'To be continued...',
			],
		},
	];
