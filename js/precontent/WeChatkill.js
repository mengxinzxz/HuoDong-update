...
const packs = function () {
    var WeChatkill = {
        ...
        translate: {
            ...
            wechat_yangfu: '微信杨阜',
            wechatjiebing: '借兵',
            wechatjiebing_info: '锁定技，当你受到伤害后，你选择一名其他角色，随机获得其一张牌并展示。若此牌为装备牌，则你使用之。',
