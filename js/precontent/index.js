    ...
    game.showExtensionChangeLog((() => {
        ...
        _status.HDWJ_ChangeLog = [
            ...
            },
            {
                type: 'players',
                data: [
                    'Mbaby_dukui', 'Mmiao_guanyinping', 'Mbaby_mifangfushiren', 'Mfight_dianwei', 'Mbaby_zhugeruoxue', 'Mbaby_star_xunyu', 'Mbaby_shen_daxiaoqiao', 'Mbaby_jiachong', 'Mbaby_wuban', 'Mfight_machao', 'Mbabysp_sunjian', 'Mbaby_re_xunyu', 'Mbaby_dc_sb_chengyu', 'Mbaby_hejin', 'Mbaby_taoqian', 'Mbaby_sunhuan', 'Myin_xushu', 'Mmiao_mayunlu',
                    'wechat_zhaoyun', 'wechat_re_zhaoyun', 'wechat_sb_xiahouyuan', 'wechat_sb_xiaoqiao', 'wechat_shen_caocao', 'wechat_sb_sunquan', 'wechat_zhiyin_zhugeke', 'wechat_re_liubiao', 'wechat_re_weiyan', 'wechat_sb_huaxiong', 'wechat_zhi_yuanshu', 'wechat_zhi_fuhuanghou', 'wechat_zhi_caojie', 'wechat_zhi_caocao', 'wechat_zhi_zhangjiao', 'wechat_shen_zhangliao', 'wechat_ruanji', 'wechat_zhiyin_qinmi',
            ...
            },
            {
                ...
                data: [
                    ...
                    '欢杀：杜夔、喵关银屏、糜芳傅士仁、战典韦、诸葛若雪、星荀彧、神二乔、贾充、吴班、战马超、SP欢杀孙坚、界荀彧、谋程昱、何进、陶谦、孙桓、隐徐庶、喵马云騄',
                    '微信：赵云、界赵云、谋夏侯渊、谋小乔、神曹操、谋孙权、极诸葛恪、界刘表、界魏延、谋华雄、志袁术、志伏皇后、志曹节、志曹操、志张角、神张辽、阮籍、极秦宓；重新分配微信三国杀的武将分包',
                    '其他：天降奇兵——孙寒华、狂神(重置版)、吾猪万睡、沐如风晨、点点(带16张皮肤，可在本体换肤界面中切换)、重置活动群名人堂&肘击群&寝室群部分角色、双面乐大乔、双面乐小乔、双面阿会喃、双面董荼那',
                    '使用扩展千幻聆音的朋友可以关闭扩展修改本体资料页功能设置暂时解决修改ui.click.charactercard的冲突',
                    'To be continued...',
                ],
            },
        ];
