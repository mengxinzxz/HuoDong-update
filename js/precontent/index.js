    ...
    game.showExtensionChangeLog((() => {
        ...
        _status.HDWJ_ChangeLog = [
            ...
            },
            {
                type: 'players',
                data: [
                    'wechat_shantao', 'wechat_sb_yujin', 'wechat_sb_lvmeng', 'wechat_sb_lvbu', 'wechat_old_sunluyu', 'wechat_old_guanyinping', 'wechat_sb_sp_zhugeliang', 'wechat_sb_zhugeliang', 'wechat_re_huangzhong', 'wechat_jushou', 'wechat_sb_zhouyu',
            ...
            },
            {
                ...
                data: [
                    'bugfix、素材补充、技能调整',
                    '小程序：山涛、谋于禁、谋吕蒙、谋吕布、牢大孙鲁育、牢大关银屏、谋诸葛亮、界黄忠、沮授、谋周瑜',
