    ...
    game.showExtensionChangeLog((() => {
        ...
        _status.HDWJ_ChangeLog = [
            ...
            },
            {
                ...
                data: [
                    'bugfix、素材补充、技能调整',
                    '小程序：山涛、谋于禁、谋吕蒙、谋吕布、牢大孙鲁育、牢大关银屏、谋诸葛亮、界黄忠、沮授、谋周瑜、曹纯、庞德公、王元姬、沙摩柯、志徐氏、志曹植',
