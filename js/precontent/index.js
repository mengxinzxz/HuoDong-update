    ...
    game.showExtensionChangeLog((() => {
        ...
        _status.HDWJ_ChangeLog = [
            ...
            },
            {
                type: 'players',
                data: [
                    'Mbaby_dukui', 'Mmiao_guanyinping', 'Mbaby_mifangfushiren', 'Mfight_dianwei', 'Mbaby_zhugeruoxue', 'Mbaby_star_xunyu', 'Mbaby_shen_daxiaoqiao', 'Mbaby_jiachong', 'Mbaby_wuban', 'Mfight_machao', 'Mbabysp_sunjian', 'Mbaby_re_xunyu', 'Mbaby_dc_sb_chengyu', 'Mbaby_hejin', 'Mbaby_taoqian', 'Mbaby_sunhuan', 'Myin_xushu',
            ...
            },
            {
                ...
                data: [
                    ...
                    '欢杀：杜夔、喵关银屏、糜芳傅士仁、战典韦、诸葛若雪、星荀彧、神二乔、贾充、吴班、战马超、SP欢杀孙坚、界荀彧、谋程昱、何进、陶谦、孙桓、隐徐庶',
